    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rg_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String status = "Hey, I'm using ChatEasy";
                ...
                if (TextUtils.isEmpty(namee) || TextUtils.isEmpty(emaill)|| TextUtils.isEmpty(Password)|| TextUtils.isEmpty(cPassword)){
                    ...
                    progressDialog.dismiss();
                    rg_password.setError("Passwords does not match!");
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                ...
                                if (imageURI!=null){
                                    ...
                                    String status = "Hey, I'm using ChatEasy";
                                    imageuri = "https://firebasestorage.googleapis.com/v0/b/easychat-3db77.appspot.com/o/man.png?alt=media&token=20859ef3-59b8-4588-9ec7-191d5a1f3870";
                                    Users users = new Users(id, namee, emaill, Password, imageuri, status);
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
